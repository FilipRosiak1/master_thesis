...
def _reconstruct_strings_from_batch(model_name: str, model, batch: torch.Tensor, idx2char: dict[int, str] | None) -> list[str]:
    ...
    if model_name in {"tree_vae", "tree_vae_masked", "tree_vae_masked_lhs", "tree_vae_masked_lhs_depth", "tree_vae_masked_lhs_cond", "tree_vae_masked_lhs_struct_cond"}:
    ...
    *,
    ...
    for epoch in range(epochs):
        ...
        for batch in dataloader:
            ...
            elif model_name in {"tree_vae", "tree_vae_masked", "tree_vae_masked_lhs", "tree_vae_masked_lhs_depth", "tree_vae_masked_lhs_cond", "tree_vae_masked_lhs_struct_cond"}:
