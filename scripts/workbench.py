...
def _interactive_menu() -> int:
    ...
    if command == "pipeline":
        model = input("Model [char_vae/grammar_vae/grammar_vae_masked/tree_vae/tree_vae_masked/tree_vae_masked_lhs/tree_vae_masked_lhs_depth/transformer_vae/vq_grammar_ae]: ").strip()
